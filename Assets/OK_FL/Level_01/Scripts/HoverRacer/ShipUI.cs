    ...
    
{
    ...
    public TextMeshProUGUI currentLapText;      //The text element for the current lap RacePosition
    
    //public TextMeshProUGUI currentCPText;    //The text element check point
    ...
    //{
    //    currentCPText.text = cpManager.checkpoint.ToString();
